...
## Le 11 assicurazioni sociali (da sapere a memoria)

AVS · AI · PC · LPP · LAMal · LAINF · LAM · LIPG · LADI/LPTD · LAFam

**Cosa fanno:**
- Sostituiscono un reddito (es. indennità di disoccupazione)
- Compensano un costo (es. rimborso spese mediche)
...
**Percorso tipico in caso di crisi:**
1. Risparmio personale esaurito
2. Indebitamento
3. Caduta in assistenza sociale

---

## I pseudo-indipendenti e il lavoro atipico

Figure ibride non facilmente classificabili: rider, lavoratori digitali, addetti alle pulizie, artigiani con SAGL.

Per essere riconosciuto indipendente dall'AVS:
- Almeno 5 clienti
