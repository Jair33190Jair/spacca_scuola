...
## Il sistema dei tre pilastri — fotografia d'insieme

Immagina un albero. Le radici sono il **primo pilastro**: obbligatorio, universale, garantisce la sopravvivenza. Il tronco è il **secondo pilastro**: professionale, ti permette di mantenere il tenore di vita che avevi. I rami più in alto sono il **terzo pilastro**: facoltativo, lo costruisci tu se vuoi e puoi.
...
Il secondo copre gli stessi tre rischi, ma per l'invalidità da infortunio interviene prioritariamente l'**AINF** (Assicurazione contro gli infortuni).
...
- **Prestazioni collettive**: finanziamento di organizzazioni come Pro Senectute, che aiutano le persone anziane a orientarsi nel sistema e a richiedere le prestazioni
...
### Come funziona la procedura AI

1. **Rilevamento tempestivo** (entro 30 giorni): si attiva non appena emerge una situazione di rischio
...
## Primo pilastro: Prestazioni Complementari (PC)

Questo è uno dei temi più pratici per il tuo futuro lavoro. Prestaci attenzione.
...
Solo i **beneficiari di una rendita AVS o AI** il cui reddito e una quota del patrimonio non supera una certa soglia. Senza rendita, nessuna PC.
...
| Voce | Importo annuo |
|------|--------------|
| Rendita AVS | CHF 15'120 |
| Cassa pensione (2° pilastro) | CHF 3'600 |
| Provento della sostanza | CHF 105 |
| Computo patrimonio (1/10 di CHF 15'000)* | CHF 1'500 |
| **Totale entrate** | **CHF 20'325** |
...
- **Lacune contributive**: lavori stagionali, disoccupazione prolungata, basse ore settimanali
- **Bassi salari** → capitale accumulato basso
- **Divorzio**: il capitale accumulato durante il matrimonio va diviso tra i coniugi
- **Prelievo anticipato**: per acquistare casa primaria, avviare un'attività indipendente, lasciare definitivamente la Svizzera per paese extra-UE/AELS
- **Fluttuazioni dei mercati finanziari**: i rendimenti non sono garantiti
...
Copre le conseguenze economiche di infortuni professionali e non professionali, e malattie professionali.
...
- **Lezione 01–03**: storia e sviluppo dello stato sociale svizzero (dispensa, pp. 1–60)
- **Lezione 04**: sistema dei tre pilastri — prima introduzione, schema della piramide rovesciata
