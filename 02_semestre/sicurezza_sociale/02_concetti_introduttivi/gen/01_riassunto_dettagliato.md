...
> cornice dentro cui ogni argomento futuro troverà posto: cos'è lo Stato sociale, da dove viene,
> a cosa serve, e di quali pezzi è fatto. Vale la pena capirlo bene adesso — risparmia confusione dopo.
...
Pensa a un albero con radici profonde: le **radici** sono i valori fondanti (uguaglianza, solidarietà, giustizia sociale, sussidiarietà, responsabilità individuale), il **tronco** è la struttura giuridica e istituzionale, e i **rami** sono le sue componenti concrete. Tutto regge insieme — ma ci vuole tempo perché un albero del genere cresca.
...
## Il dibattito ideologico: quanto Stato?
...
Fin qui il quadro generale. Ora entriamo nella struttura interna — e qui le cose si fanno concrete.

---

## Le quattro componenti dello Stato sociale

Lo Stato sociale si articola in quattro grandi pilastri:

```
┌─────────────────────────────────────────────┐
│               STATO SOCIALE                 │
├────────────┬───────────┬──────────┬─────────┤
│ Sicurezza  │ Politiche │ Diritto  │ Servizi │
│  sociale   │  sociali  │del lavoro│pubblici │
└────────────┴───────────┴──────────┴─────────┘
```
...
Regola il rapporto tra lavoratori e datori di lavoro. Le principali basi giuridiche svizzere:

| Fonte giuridica | Contenuto |
|---|---|
| **CO** art. 319 ss. | Contratto individuale di lavoro |
| **CO** art. 356 ss. | Contratto collettivo di lavoro (CCL) e contratto normale di lavoro |
...
I servizi pubblici sono erogati da:
- **enti pubblici diretti** (uffici e servizi dello Stato) → *azione sociale pubblica*
- **attori privati** (*azione sociale privata*):
  - associazioni (art. 60–79 CC svizzero)
  - fondazioni di utilità pubblica (art. 80–89 CC svizzero)
  - società private con scopo di lucro
...
| Rischio sociale | Funzione di sicurezza sociale corrispondente |
|---|---|
| Disoccupazione (perdita di guadagno) | Sostituzione del reddito → indennità di disoccupazione |
| Oneri familiari (costi per la figlia piccola) | Complemento → assegni familiari |
| Povertà e esclusione sociale (se la situazione si prolunga) | Risorse di base / minimo vitale → assistenza pubblica |
...
Una distinzione fondamentale introdotta verso fine lezione, necessaria per usare bene la guida del corso:

| | **Assicurazioni sociali** | **Prestazioni commisurate al bisogno** |
|---|---|---|
| **Logica** | Assicurativa: versi contributi, sei tutelato | Del bisogno: dimostri di non avere risorse sufficienti |
| **Finanziamento** | Contributi/premi prelevati sul salario | Imposte (reddito e sostanza) |
| **Accesso** | Essere assicurati (affiliati e aver versato contributi) | Sussidiario: interviene *dopo* le assicurazioni sociali |
...
| **Prestazione commisurata al bisogno** | Tutela sussidiaria, condizionata alla dimostrazione del bisogno economico |
| **Stato attivatore** | Modello che enfatizza responsabilità individuale e obblighi per i beneficiari di prestazioni |
| **Grandi invalidi / ADL** | Persone che necessitano di assistenza regolare per le attività di base della vita quotidiana |

---

## Collegamenti

- **Lezione 01 (seminario):** già affrontati rischio sociale, definizione funzionale e analitica di sicurezza sociale — questa lezione li integra nel quadro più ampio dello Stato sociale.
- **Prossime lezioni:** il prof Grepi approfondirà le assicurazioni sociali; la collega Ornella parlerà delle politiche familiari (fine aprile).
- **Esercizio semestrale:** storia di una persona dalla nascita alla vecchiaia — identificare rischi e prestazioni per ogni fase. Consegna: **29 maggio**. Consiglio: procedere in parallelo con il corso.
- **Risorsa esterna:** sito `sicurezasociale.ch` — storia e guida al sistema di sicurezza sociale svizzero, ben illustrato e chiaro.
- **Temi aperti:** distinguere precisamente i confini tra sicurezza sociale, politiche sociali e diritto del lavoro (concetti che si sovrappongono parzialmente).
