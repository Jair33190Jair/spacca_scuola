...
| Componente | In breve |
|---|---|
| **Sicurezza sociale** | Tutela contro rischi sociali specifici — tema centrale del corso |
| **Politiche sociali** | Tutte le azioni pubbliche per il benessere e i diritti sociali (sanità, famiglia, lavoro, istruzione, alloggio) |
| **Diritto del lavoro** | Contratti, orari, protezione del lavoratore (basi: CO, LL, LAINF) |
| **Servizi pubblici** | Erogati da enti pubblici (azione sociale pubblica) o privati (associazioni, fondazioni) |
...
1. **Prestazioni monetarie** (assegni familiari, indennità maternità/paternità, borse di studio) → rientrano nella sicurezza sociale
2. **Servizi alle famiglie** (asili, doposcuola, mediazione)
3. **Disposizioni giuridiche** (Codice civile: matrimonio, divorzio, tutela minori)
