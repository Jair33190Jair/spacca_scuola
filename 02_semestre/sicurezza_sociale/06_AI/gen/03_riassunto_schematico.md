...
- <span class="c-tesi">**Professionali** (<span class="c-dato">art. 15 ss.</span>) →</span>
  ...
  - assegno per introduzione al datore (art. 18b)
  - aiuto in capitale (art. 18d)
...
|---|---|---|
| Congedo di assistenza | art. 329h CO | Max 3 gg/evento · 10 gg/anno · cert. medico |
| Indennità di assistenza | IPG | Figlio minorenne grave malattia · max 98 gg (18 mesi) |
| Accrediti compiti assistenziali | AVS | Supplemento per calcolo rendita AVS futura |
| AGI (Assegno grandi invalidi) | AI/AVS | Copertura spese per aiuto di terzi |
...
`AI` · `LAI` · `LISPI` · `grado d'invalidità` · `rendita straordinaria` · `provvedimenti professionali` · `intervento tempestivo` · `rilevamento tempestivo` · `contributo per l'assistenza` · `AGI` · `caregiver burden` · `familiare curante` · `sistema meritocratico-occupazionale` · `indennità di assistenza` · `SACD` · `CDSA`
