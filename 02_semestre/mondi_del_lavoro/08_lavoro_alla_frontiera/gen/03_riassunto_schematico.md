...
## Origini storiche del frontalierato moderno
...
- Motivo: frontalieri = versione estrema del **Gastarbeiter** (lavoratore ospite)
  ...
  - Non "pesano" socialmente né ambientalmente

---

## Legge federale del 1931 — modello europeo
...
`frontalierato` · `pendolarismo internazionale` · `breve raggio` · `mobilità da lavoro` · `osmosi` · `Gastarbeiter` · `permesso G` · `notificati` · `fascia di frontiera` · `differenziali salariali` · `accordi bilaterali` · `approccio laico`
