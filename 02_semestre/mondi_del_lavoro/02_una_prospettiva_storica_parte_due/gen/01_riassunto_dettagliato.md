...
> Qui scendiamo nel concreto: taylorismo, fordismo, crisi, post-fordismo — e una dimensione spesso dimenticata nei libri di testo: la questione di genere nel mondo del lavoro. Tanta roba, ma vale la pena.

---

## Che cos'è il "lavoro" (richiamo dalla sessione 01)
...
Il contesto storico in cui tutto si inserisce è quello delle **quattro rivoluzioni industriali**:

| Periodo | Tecnologia chiave | Conseguenza sociale |
|---|---|---|
| Fine 1700 – 1800 | Carbone e macchina a vapore | Condizioni di lavoro durissime, nascita dei primi sindacati |
| Fine 1800 – 1980 | Elettricità, petrolio, motore a scoppio | Produzione di massa, crescita del movimento operaio, nascita del welfare |
| Anni '80 – 2008 | ICT, globalizzazione, politiche neoliberiste | Ridimensionamento del welfare, flessibilizzazione |
| 2008 – oggi | Digitalizzazione | Impatti profondi su tutti gli ambiti della società |

Tieni questo schema in testa: è la cornice entro cui tutto il resto si muove.
...
Chi pensa e chi esegue devono essere persone diverse. Il management decide *come* si lavora, l'operaio esegue. Questo è il cuore del taylorismo.

I principi si articolano in tre livelli:
...
- **Stabilità dei rapporti di impiego e aumento dei salari** (almeno per la manodopera maschile e bianca)
...
## Critiche e crisi del sistema taylorista-fordista

Il sistema funziona per decenni. Poi le crepe iniziano a mostrarsi, da più parti.
...
Le critiche sul campo sono ancora più dirette:
...
Il sistema post-fordista si caratterizza per:
- **Finanziarizzazione dell'economia** (ricerca di profitti relativamente slegati dalla produzione reale)
...
4. **Esigenze del mercato**: il modello post-fordista ha bisogno di manodopera flessibile — e le donne rappresentano storicamente la categoria più "disponibile" alla flessibilità
...
| Termine | Significato |
|---|---|
| **Lavoro eterodiretto** | Lavoro in cui mezzi e fini sono decisi dal management, non dal lavoratore |
| **Taylorismo** | Organizzazione scientifica del lavoro basata su divisione verticale e orizzontale dei compiti |
| **One best way** | Principio taylorista: esiste un solo modo ottimale per ogni compito |
| **Fordismo** | Sistema produttivo basato su catena di montaggio, produzione di massa e welfare state |
| **Post-fordismo** | Sistema produttivo flessibile, orientato alla domanda, con finanziarizzazione e terziarizzazione |
| **Lean production** | Produzione snella giapponese: just-in-time e qualità totale |
| **HRM (Human Resource Management)** | Ideologia manageriale che valorizza l'individuo, escludendo la rappresentanza collettiva |
...
- **Prossime lezioni** — La quarta rivoluzione industriale: digitalizzazione del lavoro e impatti sulla società
- **Approfondire:**
  - Cavalca, Mingione, Pugliese (2024) — *Il lavoro, dalla rivoluzione industriale alla transizione digitale*, Carocci
  - Federici, S. (2020) — *Il calibano e la strega*, Mimesis
  - Gallino, L. (2009) — *Il lavoro non è una merce*, Laterza
  - Castel, R. (2015) — *Incertezze crescenti*, Editrice Socialmente
