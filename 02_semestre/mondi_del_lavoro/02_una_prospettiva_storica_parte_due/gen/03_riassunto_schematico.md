...
| Periodo | Tecnologia | Effetti sociali |
|---|---|---|
| Fine 1700–1800 | Carbone, vapore | Condizioni dure, nascita sindacati |
| Fine 1800–1980 | Elettricità, petrolio | Produzione di massa, welfare state |
| Anni '80–2008 | ICT, globalizzazione | Flessibilizzazione, neoliberismo |
| 2008–oggi | Digitalizzazione | Impatti su tutta la società |
...
## Taylorismo-fordismo vs. Post-fordismo

| Dimensione | Fordismo | Post-fordismo |
|---|---|---|
| Produzione | Massa, standardizzata | Flessibile, personalizzata, just-in-time |
| Impresa | Grande, gerarchica | Piccola/media, a rete |
| Lavoro | Parcellizzato, monotono | Flessibile, autonomo ma intenso |
| Contratti | Standard, piena occupazione | Non standard, segmentati |
| Genere | "Casalighizzazione" femminile | Femminilizzazione precaria |
...
## Dati Ticino / Svizzera (2023–2025)
...
| Chi | Cosa | Quando |
|---|---|---|
| Adam Smith | *La ricchezza delle nazioni*, descrizione parcellizzazione | 1776 |
| Frederick Taylor | *I principi dell'organizzazione scientifica del lavoro* | 1911 |
| Henry Ford | Catena di montaggio, fordismo | 1863–1947 |
| Antonio Gramsci | *Americanismo e fordismo*, *Quaderni dal carcere* | 1891–1937 |
| Elton Mayo | Esperimenti Western Electric Chicago (relazioni umane) | 1924 |
| Tavistock Institute | Fabbrica come sistema sociotecnico | 1946 |
| Alain Touraine | *L'evoluzione del lavoro operaio alla Renault* | 1955 |
| Ustat Ticino | *Le cifre della parità*, edizione 2025 | 2025 |

---

### Parole chiave

`taylorismo` · `fordismo` · `post-fordismo` · `one best way` · `just-in-time` · `lean production` · `HRM` · `segregazione orizzontale` · `segregazione verticale` · `soffitto di cristallo` · `effetto a imbuto` · `femminilizzazione del lavoro` · `lavoro di riproduzione sociale` · `terziarizzazione` · `finanziarizzazione` · `divario salariale` · `lavoro eterodiretto`
