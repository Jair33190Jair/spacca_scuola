...
| Sigla | Contenuto |
|-------|-----------|
| DD | Diverse Desires — desideri diversi |
| DB | Diverse Beliefs — credenze diverse |
| KA | Knowledge-Access — accesso diverso alla conoscenza |
| FB | False Belief — credenza falsa |
| HE | Hidden Emotion — emozione nascosta |
...
| Stadio | Età | Caratteristica | Precondizione |
|--------|-----|---------------|---------------|
| Distress empatico globale | 0–12 mesi | Contagio emotivo; nessuna distinzione sé/altro | Programmazione filogenetica |
| Distress empatico egocentrico | 12 mesi–2 anni | Aiuta l'altro con ciò che è consolante per sé | Costanza dell'oggetto; riconoscimento emozioni altrui |
| Distress empatico quasi-egocentrico | 2–6 anni | Feedback correttivi; capisce il bisogno ma usa soluzioni proprie | Linguaggio; TOM (teoria della mente) |
...
## I 6 Bias dell'Empatia

*(Elaborazione originale Pezzoli — non presente in letteratura in questa forma)*
...
`Einfühlung` · `empatia cognitiva` · `empatia affettiva` · `simulazione incarnata` · `neuroni specchio` · `contagio emotivo` · `distress empatico globale` · `decentramento` · `assunzione di prospettiva` · `Theory of Mind` · `TOM` · `bias empatico` · `sovrattivazione empatica` · `compassione` · `feedback correttivo` · `pensiero formale`
