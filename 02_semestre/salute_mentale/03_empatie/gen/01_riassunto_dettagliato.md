...
Cent'anni dopo, **Vittorio Gallese (2003)** chiuderà il cerchio introducendo la teoria dei **neuroni specchio** e la **simulazione incarnata** (*embodied simulation*): il meccanismo neurologico che sottende imitazione, empatia e mentalismo. Quando vedo qualcuno compiere un'azione, nel mio cervello si attivano gli stessi neuroni che si attiverebbero se fossi io a compierla. È automatico, pre-riflessivo, inconscio. Il corpo "mima" l'altro prima ancora che la mente lo decida.
...
La capacità di decentrarsi, di "uscire da sé" per cogliere il punto di vista dell'altro. Questo richiede il superamento dell'egocentrismo piagetiano (stadio preoperatorio, dai 2 ai 6-7 anni). Prima dei 6 anni non può esistere vera empatia in questo senso — il cervello non ha ancora gli strumenti.

**Componente cognitiva 2 — Decodifica degli stati emotivi altrui:**
La capacità di leggere i segnali emotivi dell'interlocutore, interpretarne lo stato interiore. Ogni emozione è un atto di valutazione protocognitiva della realtà — capire quello che l'altro sente richiede un'elaborazione cognitiva attiva.

**Componente affettiva — Risonanza emotiva:**
La capacità di *sentire* qualcosa di simile a quello che prova l'altro. Per la Feshbach questa è **il sale dell'empatia** — senza di essa, non c'è vera empatia. Ma non è sufficiente da sola.
...
- **Imitazione motoria:** i muscoli del viso mimano l'espressione dell'altro, e questo provoca l'emozione corrispondente. Ekman (1992) lo dimostrò: imitare un'espressione facciale tende a produrre l'emozione associata. Darwin lo aveva già intuito nel 1872.
- **Reazione circolare primaria:** risposta innata e selettiva al segnale sociale — i neonati reagiscono al pianto di altri neonati, non a rumori equivalenti di altra natura.
...
**Janet Strayer** distingue due modalità di condivisione:
- **Condivisione parallela** (meno matura): l'osservatore richiama una propria esperienza simile, con le relative emozioni. L'altro non entra davvero in gioco.
- **Condivisione transitoria** (più matura): l'osservatore entra nel vissuto specifico dell'altro, capisce che le emozioni di quell'altro possono essere diverse dalle proprie.
...
Gli psicopatici possono essere molto capaci di empatia **cognitiva** — sanno leggere benissimo la prospettiva e i bisogni dell'altro. La usano per manipolare. Quello che manca loro è l'empatia **emotiva** (registro affettivo automatico). Keysers e Gazzola (2014) li descrivono come capaci di modulare la propria empatia come la manopola del volume di una radio: alzandola per conquistare fiducia, abbassandola nel momento del danno.
...
La **compassione** (*com-patire*, soffrire con) si caratterizza per:
- Riconoscimento della sofferenza
- Relazione con la persona che soffre
- **Reazione proattiva:** non solo si sente la sofferenza, si è motivati a migliorare il benessere dell'altro
...
| Termine | Significato |
|---------|-------------|
| **Einfühlung** | "Sentire dentro" — termine tedesco originario, tradotto come empatia nel 1909 |
| **Simulazione incarnata** | Meccanismo neurologico per cui imitiamo internamente ciò che vediamo fare (Gallese) |
| **Neuroni specchio** | Neuroni attivi sia nell'azione propria che nell'osservazione dell'azione altrui |
| **Contagio emotivo** | Forma primitiva di empatia: involontaria, automatica, senza mediazione cognitiva |
| **Distress empatico globale** | Prima forma di empatia (neonato): non distingue sé dall'altro |
| **Distress empatico egocentrico** | Tentativi di aiuto basati su ciò che è consolante per sé |
| **Distress empatico quasi-egocentrico** | Empatia con feedback correttivi: inizia a capire il bisogno specifico dell'altro |
| **TOM — Theory of Mind** | Capacità di dedurre stati mentali, credenze ed emozioni altrui (circa 4 anni) |
| **Assunzione di prospettiva** | Capacità cognitiva di vedere le cose dal punto di vista dell'altro |
| **Decentramento** | Uscire dalla propria prospettiva egocentrica (Piaget, dai 6 anni) |
| **Bias empatico** | Errori sistematici che distorcono o bloccano la risposta empatica |
| **Sovrattivazione empatica** | Quando la sofferenza empatica diventa intollerabile e porta all'allontanamento |
| **Compassione** | Sentire per l'altro + motivazione proattiva a migliorarne il benessere |
| **Empatia cognitiva** | Componente razionale: decodifica e assunzione di prospettiva |
| **Empatia affettiva/emotiva** | Componente emotiva: risonanza, sentire quello che sente l'altro |
