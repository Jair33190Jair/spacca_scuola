...
|---|---------|--------------|
| 01 | Introduzione al modulo | Salute, benessere, normalità, modelli concettuali |
...
- **Salute** → non ha una definizione semplice (Lez. 01)
  - 7 condizioni di Boorse (1977): nessuna è sufficiente da sola
  - Valore · trattamento medico · norma statistica · sofferenza ·
    disabilità · adattamento · omeostasi
- **Disease / Illness / Sickness** → tre dimensioni che non coincidono (Lez. 01)
...
- **Gehirnpsychiatrie** → follia = malattia del cervello (Lez. 02)
...
- **Alienazione** → essere "altrove", fuori dal proprio mondo (Lez. 02)
