...
Pattern che:
- **Devia** dalle aspettative culturali
- È **pervasivo e inflessibile** in molteplici situazioni
- Causa **disagio** o **compromissione** significativa
- È **stabile** nel tempo; esordio in **adolescenza o prima età adulta**
...
| Shea et al. | Studio comorbilità su veterani PTSD | 1999 |

---

### Parole chiave

`temperamento` · `carattere` · `personalità` · `tratto` · `stato` · `goodness of fit`
`diatesi` · `corazza caratteriale` · `egosintonia` · `scissione` · `identificazione proiettiva`
`diffusione dell'identità` · `organizzazione borderline` · `cluster A/B/C`
`DSM-5-TR` · `PDM-2` · `Big Five` · `BPD` · `DBT`
