...
> concreto: quali metodi esistono? Come si classificano le tipologie
> di osservazione? E soprattutto: quali strumenti usi davvero sul campo?
> È una lezione densa ma molto pratica — esattamente quello che ti servirà
> in stage.

---

## Premessa: perché dare forma ai dati osservativi
...
## Le Tipologie di Osservazione in Ambito Socio-Educativo
...
> suo ambiente naturale, instaurando un rapporto di interazione personale
...
perché è il metodo più adatto quando si vuole interrogare l'efficacia di
un intervento educativo in un contesto reale.
...
## Limiti delle due tipologie principali

Il prof dedica una sezione ai limiti, non per sminuire i metodi ma per
capire quando e come usarli — o combinarli.

### Limiti dell'Osservazione Partecipante
...
### Limiti dell'Osservazione Sistematica
...
## Le Tecniche di Osservazione: gli Strumenti

Arriviamo alla parte più operativa. Le tecniche si scelgono in base a:
- Lo **scopo** dell'osservazione
- Il **tipo** di osservazione
- Le **possibilità reali** di raccogliere dati in quel contesto

Si dividono in **narrative** e **sistematiche**.

### Tecniche Narrative

Permettono di descrivere i fenomeni senza una predisposizione rigida
di elementi specifici da osservare. Colgono la complessità delle relazioni.
...
Struttura minima:
- **Data**
- **Contesto** (chi era presente, dove)
- **Descrizione dell'episodio** (cosa è successo, in modo fedele)
- **Interpretazione/ipotesi** (separata dalla descrizione)
...
- Partecipanti
- Argomenti trattati
- Osservazioni dell'équipe (sintesi delle criticità e del confronto)
- Decisioni prese (solo quelle condivise)
...
Queste tecniche rilevano dati in forma strutturata. Il principio comune:
...
- **Scala descrittiva**: "si lava i denti da solo", "si lava con aiuto",
  "si fa lavare dall'educatore"
...
2. Più osservazioni regolari ripetute nel tempo
3. Minor tempo possibile tra l'atto di osservare e la sua trascrizione
4. Uso di uno strumento coerente con gli obiettivi
5. Dimestichezza nell'utilizzo dello strumento
...
| Termine | Significato |
|---------|-------------|
| **Fruibilità del dato** | Capacità di un'osservazione di essere compresa e usata da altri, anche a distanza di tempo |
| **Grado di partecipazione** | Quanto l'osservatore è coinvolto/in relazione nel campo osservato |
| **Grado di controllo** | Quanto l'osservatore può modificare le variabili del contesto |
| **Item** | Elemento osservabile in cui viene scomposto un comportamento complesso |
| **Effetto Hawthorne** | Tendenza delle persone a modificare il comportamento quando sanno di essere osservate |
| **Osservazione occasionale** | Osservazione spontanea, non strutturata, che coglie qualcosa di significativo |
| **Osservazione documentaria** | Studio di documenti esistenti (diari, referti, cartelle) |
| **Osservazione partecipante** | Immersione nel campo relazionale per un periodo lungo; paradigma di Malinowski |
| **Osservazione sistematica** | Molto strutturata, alta replicabilità, bassa partecipazione |
| **Tecniche narrative** | Strumenti aperti: annotazioni aneddotiche, diario di bordo, verbale |
| **Tecniche sistematiche** | Strumenti strutturati: check-list, griglia, scala di valutazione, videoregistrazione |
| **Replicabilità** | Possibilità di ripetere un'osservazione con risultati confrontabili tra osservatori diversi |
| **Auto-osservazione** | Esplicitare il proprio stato, i propri filtri e le proprie ipotesi come parte dell'osservazione |
...
### Lezione 07 — Prima Parte (collegamento diretto)

Questa lezione è la continuazione diretta della 07. Lì avevamo visto:
- Che cos'è l'osservazione professionale e perché è diversa dall'osservare
  "nella vita comune"
- Le **cinque componenti essenziali** di qualsiasi sistema osservativo:
  intenzionalità, oggetto, soggetto, campo, auto-osservazione
- Lo **sguardo relazionale** come base — prima degli strumenti, c'è la
  postura
...
- La settimana successiva: seminario di discussione sugli strumenti
  utilizzati nell'esercitazione pratica in aula (documentario su Guido).
