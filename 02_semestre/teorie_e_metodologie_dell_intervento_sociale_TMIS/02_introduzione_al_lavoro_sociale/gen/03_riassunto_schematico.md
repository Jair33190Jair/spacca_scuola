...
- **Sé molteplice** → la letteratura esclude un Sé monolitico
  - Postmodernità → Sé multiplo, saturato, frammentato
...
| Elemento | Funzione |
|----------|----------|
| Assunzione di consapevolezza | Identificare problemi, risorse, soluzioni |
| Indipendenza | Stabilire confini, prendere distanza da ciò che manipola |
| Relazioni | Scegliere interlocutori positivi |
| Iniziativa | Dominare l'ambiente, trovare piacere nelle attività costruttive |
| Creatività | Amplificare lo sguardo, esprimere emozioni positivamente |
...
| Livello | Tipo |
|---------|------|
| 5 (apice) | Autorealizzazione / Spiritualità |
| 4 | Stima / Progettualità |
...
| Chi | Cosa | Quando |
|-----|------|--------|
| Mancini, T. | Psicologia dell'identità, Il Mulino | 2010 |
| Erikson, E. | Sentimento di identità a tre livelli | 1968 |
| Glodis & Blasi | 4 forme di esperienza soggettiva del Sé | 1993 |
| Pedroni, M.C. | Vulnerabilità: un concetto da maneggiare con cura | 2020 |
| Palmieri, C. | Un'esperienza di cui aver cura, FrancoAngeli | 2011/2012 |
| Malaguti, E. | Educarsi alla resilienza, Erickson | 2005 |
| Cyrulnik, B. | Tutori di resilienza | — |
| Wolin & Wolin | 7 elementi della resilienza | 1993 |
| Maslow, A. | Piramide gerarchica dei bisogni | 1954 |
| Paradiso, L. | La progettazione educativa e sociale, Mondadori | 2020 |
| Tramma, S. | L'educatore imperfetto, Carocci | 2018 |
| Bachtin, M. | Polifonia (in Mancini) | 1979 |

---

## Parole chiave

`sé dialogico` · `posizionamenti` · `identità` · `sentimento di identità` · `agency` · `otherness` · `unity` · `autoreflection` · `vulnerabilità` · `ontologica` · `stigma` · `disagio` · `resilienza` · `tutori di resilienza` · `bisogno` · `motivazione` · `bisogni evolutivi` · `bisogni complessi` · `cura autentica` · `cura inautentica` · `empowerment`
