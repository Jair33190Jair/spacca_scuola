...
- Bisogni → più letture valide
- Ruolo operatore → promuovere empowerment, non distribuire soluzioni
...
|---------|--------------|------------|
| Natura | Impulso emotivo immediato | Tendenza consapevole, orientata |
| Temporalità | Breve termine | Lungo termine |
| Progettualità | Assente o minima | Forte |
...
- **Nascita dell'idea** → attore interno/esterno ipotizza un cambiamento possibile
- **Analisi della prima idea** → motivazioni, funzionalità, effetti, canali istituzionali
- **Co-costruzione dell'idea**:
  - A. Analisi situazione-problema:
...
```
              UTENTE
          ┌──────────────┐
 Rete familiare     Rete istituzionale
 Unità abitativa    Centro diurno
          Tempo libero
```
...
**Funzioni:**
- Orientativa · Comunicativa · Decisionale · Valutativa

**Livelli:**
- **Obiettivo generale** → macrofinalità, medio-lungo termine, verbo all'infinito, soggetto = protagonista
- **Obiettivo specifico** → osservabile, breve-medio termine, rispetta ZSP

**Criteri SMART:**

| S | Semplice — chiaro per tutti |
|---|---|
| M | Monitorabile — indicatori condivisi |
| A | Auspicabile — opportuno per tutti |
| R | Realistico — ZSP, concreto |
