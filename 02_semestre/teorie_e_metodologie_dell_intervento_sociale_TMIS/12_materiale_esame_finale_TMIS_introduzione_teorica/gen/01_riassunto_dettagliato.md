...
## Indicazioni del professore sull'esame (dalla trascrizione)

L'esame è scritto, dura circa 2 ore e 15 minuti, con 6–7 domande aperte. Cose importanti:

- **Nome e cognome su ogni foglio**: i fogli vengono separati e corretti da docenti diversi.
- **Scrivere qualcosa in più non fa perdere punti**: nel dubbio, aggiungi. Ma fuori tema non porta punti.
- **Leggere tutto l'esame all'inizio**: pianifica il tempo, lascia per ultime le domande più difficili.
- **Domande con esempio pratico**: puoi usare un'esperienza personale o inventarne una coerente.
- **Potrebbe esserci una domanda analitica**: ti danno un obiettivo o un progetto e ti chiedono di analizzarlo.
- I testi obbligatori sono in Moodle. Le slide sono sintesi: i testi sono la fonte primaria.
- Il prof sottolinea che è importante **dialogare col materiale** e sviluppare un pensiero originale.

---

## Macro-tema 1 — Il contesto: modernità liquida e lavoro sociale
...
## Macro-tema 2 — L'approccio anti-oppressivo
...
## Macro-tema 3 — Con chi lavora l'operatore: la persona
...
2. L'interazione persona-ambiente è **bidirezionale** (reciprocità)
3. L'ambiente è una serie di strutture concentriche incluse l'una nell'altra
4. La visione si estende all'intero corso della vita
...
## Macro-tema 5 — Le finalità del lavoro sociale

### Le 6 finalità dell'operatore sociale
...
| Benessere | Benessere emozionale, fisico, materiale |

**I 7 principi di funzionamento:**
1. Multidimensionalità (superamento approcci unidimensionali)
2. Visione olistica (interconnessione dei domini)
3. Temporalità (i valori variano nel tempo)
4. Variabilità personale (diversa significatività per ogni persona)
5. Unicità (elementi soggettivi e oggettivi)
6. Empowerment
...
|---------|----------|-------------|
| **P** | Positive emotions | Guardare al passato con orgoglio, al futuro con speranza |
| **E** | Engagement | Essere completamente presenti in ciò che si fa (Flow) |
| **R** | Relationships | Costruire relazioni sociali forti e positive |
| **M** | Meaning | Sentire che la propria vita ha un senso |
| **A** | Achievement | Consapevolezza di aver raggiunto un traguardo; alimenta autostima e ottimismo |
...
| Elemento | Funzione |
|----------|----------|
| **Assunzione di consapevolezza** | Identificazione dei problemi, delle risorse e ricerca di soluzioni |
| **Indipendenza** | Stabilire limiti, prendere distanza da ciò che manipola, interrompere relazioni negative |
| **Relazioni** | Capacità di scegliere interlocutori positivi |
| **Iniziativa** | Dominio dell'ambiente e piacere nelle attività costruttive |
| **Creatività** | Amplifica lo sguardo, aiuta a prendere distanza dalla sofferenza |
| **Humor** | Scoprire la dimensione comica nonostante la tragedia, diminuire la tensione interiore |
| **Etica** | Guida l'azione nelle scelte positive o negative; favorisce compassione e aiuto reciproco |

---

## Macro-tema 7 — La relazione professionale dell'operatore sociale
...
| Termine | Significato sintetico |
|---------|----------------------|
| **Modernità liquida** | Società in cui nulla è stabile, le relazioni sono precarie, l'incertezza è strutturale (Bauman) |
| **Figura liquida** | L'educatore è costitutivamente incerto: debolezza strutturale ma essenziale (Tramma) |
| **Oppressione** | Esclusione forzata di persone da opportunità e risorse disponibili ai gruppi dominanti |
| **Approccio anti-oppressivo** | Pratica che svela i meccanismi di ingiustizia e promuove cambiamento micro-meso-macro |
| **Modello bio-ecologico** | 5 sistemi: Micro, Meso, Eso, Macro, Crono (Bronfenbrenner) |
| **Sentimento di identità** | Integrazione come persone, nel tempo, nel contesto sociale (Erikson/Mancini) |
| **Vulnerabilità** | Caratteristica ontologica degli esseri umani, non etichetta stigmatizzante (Pedroni) |
| **Disagio** | Situazione appresa, non irreversibile, occasione di crescita (Palmieri) |
| **Bisogni evolutivi / complessi** | Evolutivi = equilibrio; complessi = crisi e post-trauma (Paradiso) |
| **QdV — 8 domini** | Sviluppo personale, Autodeterminazione, Relazioni, Inclusione, Diritti, Benessere emoz./fisico/materiale |
| **PERMA** | Positive emotions, Engagement, Relationships, Meaning, Achievement (Seligman) |
| **Empowerment relazionale** | Processo collaborativo in cui gli esperti cedono parte del potere (Folgheraiter) |
| **Autodeterminazione** | Fare scelte in accordo con i propri valori, senza interferenze non giustificate (Wehmeyer) |
| **Autoefficacia** | Credenza nelle proprie capacità di produrre risultati (≠ autostima = valore personale) (Bandura) |
| **Resilienza** | Processo di riorganizzazione positiva nonostante le avversità (Malaguti) |
| **Tutori di resilienza** | Figure significative che permettono di "rimbalzare" (Cyrulnik) |
