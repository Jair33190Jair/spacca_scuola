...
## Le finalità dell'operatore sociale: panoramica
...
## Qualità di Vita (QdV): il modello multidimensionale
...
Schalock e Verdugo identificano otto dimensioni organizzate in tre aree trasversali:

| Area trasversale | Dominio | Indicatori principali |
|---|---|---|
| **Indipendenza** | Sviluppo personale | Educazione, abilità, comportamento adattivo |
| **Indipendenza** | Autodeterminazione | Scelte, autonomia, controllo personale, obiettivi |
| **Partecipazione sociale** | Relazioni interpersonali | Rete sociale, amicizie, attività sociali |
| **Partecipazione sociale** | Inclusione sociale | Integrazione/partecipazione nella comunità |
| **Partecipazione sociale** | Diritti | Umani (dignità, uguaglianza) e legali |
| **Benessere** | Benessere emozionale | Sicurezza, esperienze positive, concetto di sé |
...
3. **Temporalità** — i valori attribuiti variano nel corso della vita (prospettiva longitudinale)
...
## Salute e malattia: una visione tripartita
...
|---|---|---|
| **P** | Positive Emotions — Emozioni positive | Atteggiamento positivo verso passato (orgoglio), presente (gioia), futuro (speranza) |
| **E** | Engagement — Coinvolgimento | Essere completamente presenti in ciò che si fa; il concetto di **flow** (la sensazione di essere nel flusso, che il tempo vola) |
| **R** | Relationships — Relazioni positive | Costruire legami forti con familiari, amici, colleghi; impatto diretto su salute e resilienza |
...
## Empowerment: dal potenziamento individuale all'approccio relazionale
...
2. Utenti visti come potenzialmente competenti e capaci di decidere
3. Utenti capaci di autopercepirsi come agenti di cambiamento
4. Competenza acquisita attraverso l'esperienza, non ceduta dall'operatore
5. Operatori che non sostituiscono, ma **aspettano, sostengono e orientano** l'azione

---

## Autonomia: non uno stato, ma un processo

### Definizione (Tramma, 2018)

> «La condizione di chi ha la capacità di organizzare le proprie azioni, scelte, comportamenti, tenendo conto di se stessi e dei fattori che entrano in gioco nel proprio ambito esperienziale, nella complessa rete di dipendenze funzionali che lega il soggetto agli altri.»
...
## Autostima vs. Autoefficacia: due concetti distinti

Questi due termini vengono spesso confusi — per l'esame è fondamentale conoscere la differenza.
...
- La raggiungibilità dei modelli di riferimento
- La qualità delle relazioni sperimentate
- I feedback ricevuti in ambito sociale, lavorativo, affettivo

### Autoefficacia (Bandura, 2012)
...
|---|---|---|
| **Domanda** | "Quanto valgo come persona?" | "Sono capace di fare questa cosa?" |
| **Tipo di giudizio** | Valore personale | Capacità specifica |
...
| Termine | Significato |
|---|---|
| **Qualità di Vita (QdV)** | Multidimensionale; percezione soggettiva della propria posizione rispetto a 8 domini (Schalock e Verdugo) |
| **Flourishing** | Funzionamento ottimale: stare bene e funzionare efficacemente (Seligman) |
| **PERMA** | Modello del benessere: Emozioni positive, Engagement, Relazioni, Significato, Realizzazione |
| **Flow** | Stato di massimo coinvolgimento e assorbimento in un'attività (componente E del PERMA) |
| **Empowerment** | Processo di acquisizione di potere decisionale sulla propria vita, individuale e collettivo |
| **Empowerment relazionale** | Approccio postmoderno: potere condiviso tra operatori e utenti come partner (Folgheraiter) |
| **Autonomia** | Capacità di governarsi con leggi proprie nella rete di dipendenze; processo, non stato fisso |
| **Processo di autonomizzazione** | Percorso graduale verso l'autonomia (Meirieu) |
| **Autostima** | Giudizio di valore personale (Bandura) |
| **Autoefficacia** | Giudizio di capacità personale in un dominio specifico (Bandura) |
| **Disease** | Malattia biologica oggettiva (Twaddle) |
| **Illness** | Vissuto soggettivo del mal-stare (Twaddle) |
| **Sickness** | Interpretazione sociale/culturale della malattia (Twaddle) |
...
- **Temi aperti / da approfondire:**
  - Il conflitto tra autonomia individuale e autonomia collettiva (es. come gestire quando l'autonomia del singolo entra in contrasto con il benessere della comunità?)
  - Il confine tra vera autonomia e abbandono mascherato da "fare da sé"
  - Come misurare la QdV in pratica (strumenti di osservazione e valutazione)
  - L'empowerment relazionale nel progetto individuale: come si traduce operativamente?
