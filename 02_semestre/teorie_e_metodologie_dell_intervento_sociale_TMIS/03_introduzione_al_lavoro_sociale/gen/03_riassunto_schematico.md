...
| Partecipazione sociale | Inclusione sociale |
| Partecipazione sociale | Diritti |
...
|---|---|---|
| **P** | Positive Emotion | Atteggiamento positivo verso passato, presente, futuro |
| **E** | Engagement | Coinvolgimento totale; **flow** = tempo che vola |
| **R** | Relationship | Legami forti e positivi |
| **M** | Meaning | Senso nella propria vita, qualcosa di più grande di sé |
| **A** | Accomplishment | Traguardi raggiunti, autostima, ottimismo |
...
| **Domanda** | "Quanto valgo come persona?" | "Riesco a fare *questa cosa*?" |
...
`qualità di vita` · `flourishing` · `PERMA` · `flow` · `empowerment` · `empowerment relazionale` · `autonomia` · `autonomizzazione` · `autostima` · `autoefficacia` · `disease` · `illness` · `sickness` · `benessere collettivo` · `multidimensionalità` · `visione olistica`
