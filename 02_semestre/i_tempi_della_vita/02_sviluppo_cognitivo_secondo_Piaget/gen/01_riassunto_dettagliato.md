...
> «Un bravo sperimentatore deve riunire in sé due qualità spesso incompatibili: saper osservare, cioè lasciar parlare il fanciullo, non perdere nulla; e nello stesso tempo saper cercare qualcosa di preciso, avere in ogni momento qualche ipotesi di lavoro, qualche teoria — giusta o falsa — da controllare.»
> — Piaget, 1929

Le risposte del bambino durante il colloquio clinico vengono classificate in 5 tipi:

| Tipo di risposta | Descrizione |
|---|---|
| **Risposta casuale** | Il bambino risponde senza ragionare |
...
1. **Gerarchizzazione** — i stadi seguono un ordine prestabilito e universale
2. **Integrazione** — ogni stadio integra e trasforma quello precedente (non lo butta via)
3. **Strutture d'insieme** — ogni stadio forma una totalità coerente
...
### Stadio 1 — Sensomotorio (0–2 anni)

Il bambino interagisce con il mondo attraverso **sensi e movimenti**. Non c'è ancora pensiero simbolico: la realtà è ciò che si può fare con gli oggetti qui e ora.

Il periodo sensomotorio si divide in **6 sotto-stadi**:

| Sotto-stadio | Età | Caratteristica principale |
|---|---|---|
| 1. Riflessi innati | 0–1 mese | Solo riflessi (suzione, prensione) |
| 2. Reazioni circolari primarie | 1–4 mesi | Ripete azioni piacevoli sul proprio corpo |
| 3. Reazioni circolari secondarie | 4–8 mesi | Le azioni si orientano verso oggetti esterni |
| 4. Coordinazione delle secondarie | 8–12 mesi | Prime azioni intenzionali con uno scopo |
...
- Capacità di costruire teorie e verificarle
- Ragionamento su sistemi logici complessi
- Apertura al possibile, non solo al reale

---

## Il pensiero post-formale: esiste un quinto stadio?
...
- **Approfondimento**: Vygotskij offre una prospettiva alternativa sullo sviluppo cognitivo, con più enfasi sul ruolo sociale e culturale — un contrappunto interessante a Piaget, che è più centrato sull'individuo biologico.
- **Per l'esame**: i 4 stadi con fasce d'età, i meccanismi di assimilazione/accomodamento/equilibrazione, e i 4 limiti del preoperatorio (animismo, artificialismo, egocentrismo, costanza dell'identità) sono i nodi concettuali da padroneggiare.
