...
| Fase | Età | Contenuto |
|------|-----|-----------|
| **EAT** Early Adult Transition | ~17-22 | Separazione dalla famiglia; prime autonomie |
| **EAW** Entering the Adult World | ~22-28 | Prima struttura adulta provvisoria; esplorazione |
| **ATT** Age Thirty Transition | ~28-33 | Modifica prima struttura; coscienza del tempo |
...
## Le cinque dimensioni dell'adulto
...
3. *Perché?* → selezione di ciò che ha valore personale
...
|---|----------|-------------|
| 1 | Protettiva | Offrire cure adeguate |
| 2 | Affettiva | Qualità emotiva della relazione |
| 3 | Regolativa | Regolazione emotiva del bambino |
...
| 11 | Differenziale | Esprimere modalità materna e paterna |
| 12 | Transgenerazionale | Inserire il figlio in una storia generazionale |
...
`individuazione` · `puer` · `senex` · `generatività` · `stagnazione` · `marker events` · `novice phase` · `EAT` · `EAW` · `ATT` · `settling down` · `mid-life transition` · `sogno` · `mentor` · `pensiero post-formale` · `genitorialità` · `funzione alfa` · `adultescenza` · `kidult` · `identità polimorfa`
