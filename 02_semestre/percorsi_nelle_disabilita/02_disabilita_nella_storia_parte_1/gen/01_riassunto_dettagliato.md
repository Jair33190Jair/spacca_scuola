...
## L'Antichità: sopravvivenza come criterio

La storia della disabilità è vecchia quanto la specie umana. Non abbiamo fonti scritte dall'antichità preistorica — solo reperti e ipotesi degli storici — quindi è importante non credere di avere una ricostruzione completa. Sono frammenti.

Quello che si può ipotizzare con buona ragione:

- Le persone con un **deficit grave** probabilmente non sopravvivevano alla nascita (mancava qualsiasi medicina).
...
## La Mesopotamia (1700–560 a.C.): le prime leggi e classificazioni

Con la scrittura, che nasce proprio in Mesopotamia (tra Tigri ed Eufrate, zona dell'attuale Iraq), cominciano le informazioni concrete.
...
Il documento più antico che tenta una classificazione delle disabilità. Tre categorie:

| Categoria | Chi includeva |
|-----------|--------------|
| **Mostri per eccesso** | Persone con caratteristiche fisiche "in più" (macrocefalia, dita soprannumerarie, ecc.) |
| **Mostri per difetto** | Persone con arti mancanti, microcefalia, disabilità fisiche evidenti |
| **Mostri doppi** | Probabilmente i gemelli — evento così raro da essere visto come presagio di disgrazia |
...
Alcune persone con disabilità sopravvivevano comunque, esibite come curiosità nelle servitù — i cosiddetti "buffoni di corte". Una pratica che è proseguita per secoli (il *freak show* di Coney Island a New York era ancora attivo di recente).
...
## Il Medioevo: la follia come contenitore di tutto
...
La visione del "folle" era dualistica: sede di una lotta tra **Dio e Satana**.
...
**XI–XIII secolo**: il folle partecipava a **pellegrinaggi** per ottenere l'intercessione di un santo. Il prof nota — senza ironia — che non è una pratica del tutto irrazionale: un viaggio, una rottura della routine, un'esperienza comunitaria possono avere effetti positivi reali.

**XII–XIII secolo**: prime **cure mediche**, basate su:
1. Legare il folle (contenimento fisico)
2. Trattamenti alternati di luce e oscurità (nessuna base scientifica)

Le cure avvenivano a domicilio, in monasteri, o negli ospedali — che però erano luoghi di reclusione per tutti gli indesiderati: infermi, anziani, emarginati, folli. Più vicini a un carcere che a un ospedale.
...
## I Pionieri dell'Educazione: fine '700, la svolta

Fin qui ci siamo? Bene, ora viene la parte più importante.
...
|-----------|---------------------------|
| Creare un'atmosfera calma | Fine della violenza come metodo di gestione |
| Sorveglianza di carattere umano | Niente maltrattamenti, niente abusi |
| Eliminare le sanzioni fisiche | Non si picchia più |
| Sospendere gli abusi del personale | Responsabilità istituzionale |
| Mettere a disposizione libri e musica | Stimolazione culturale |
| Implicare le persone in lavori agricoli | Occupazione significativa, non isolamento |

Guardando questa lista oggi, sembra ovvia. Il fatto che dovesse essere scritta dice tutto su quello che succedeva prima.
...
- **Imbecillità**: la persona non utilizza il linguaggio

Classificazione rozza per gli standard odierni, ma rivoluzionaria per l'epoca.

---

## Jean-Marc Itard e il Ragazzo Selvaggio: nasce la pedagogia speciale moderna
...
### Itard si prende la sfida

L'istituto aveva però un mandato governativo e un finanziamento per questo ragazzo. Sicard assume Itard per occuparsene. Itard accetta come sfida scientifica.

La sua ipotesi — radicalmente diversa da quella di Sicard:
...
Itard lavora con Victor per anni, ospitandolo a casa propria. Elabora un metodo scientifico: osserva, formula ipotesi, verifica, documenta. Ecco i cinque principi:
...
- **L'imitazione** come tecnica educativa sistematica
...
| Termine | Significato |
|---------|-------------|
| **Esposizione** | Abbandono di neonati indesiderati in luogo pubblico o remoto; pratica diffusa nell'antichità |
| **Ius vivendi** | Diritto alla vita del neonato, sancito dai primi imperatori cristiani |
| **Follia** (medievale) | Categoria che raccoglieva tutti i "diversi": disabili, disagiati psichici, poveri, emarginati |
| **Grande reclusione** | Fenomeno di fine Medioevo: lebbrosari riconvertiti in luoghi di internamento per tutti gli indesiderati sociali |
| **Ospedali generali** | Istituzioni nate dai lebbrosari, luoghi di reclusione collettiva; terreno per le prime classificazioni |
| **Trattamento morale** | Metodo terapeutico di Pinel basato sull'umanizzazione del rapporto con i pazienti alienati |
| **Idiozia** | Termine scientifico di Esquirol per il deficit intellettivo congenito (oggi obsoleto e offensivo) |
| **Imbecillità** | Per Esquirol, forma più grave di idiozia, caratterizzata dall'assenza di linguaggio |
| **Demenza** | Per Esquirol, perdita di facoltà precedentemente presenti (distinta dall'idiozia) |
| **Periodo sensibile** | Finestra temporale per l'acquisizione del linguaggio, ipotizzata da Itard |
| **Generalizzazione degli apprendimenti** | Trasferimento di una competenza acquisita in un contesto a contesti diversi |
| **Pedagogia speciale** | Ramo della pedagogia nato dall'educazione di persone con disabilità; precursore della pedagogia generale |

---

## Collegamenti

- **Lezione 01**: presentazione del modulo — contesto e obiettivi del corso.
- **Lezione successiva (03)**: diritti e Convenzione ONU sulla disabilità; storia della disabilità parte 2 (Séguin e altri).
- **Lettura obbligatoria**: Matteo Schianchi, *Storia della disabilità*, 2016, pp. 180–184 ("Educare i disabili intellettivi").
- **Film da vedere**: *L'Enfant Sauvage* (1970), François Truffaut — documento di base per la pedagogia speciale. Compito: identificare e classificare gli esempi dei 5 principi pedagogici di Itard applicati con Victor; da portare al seminario della settimana successiva.
- **Temi aperti**: linguaggio e terminologia della disabilità (lezione dedicata); modelli interpretativi della disabilità; Séguin e la prima scuola per persone con deficit intellettivo (1837).
