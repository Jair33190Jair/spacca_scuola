...
## La disabilità nel mondo: una realtà che riguarda tutti
...
## L'evoluzione del termine "disabilità"

Il termine ombrello ha cambiato forma nel tempo, e ogni cambio riflette un cambiamento di mentalità:

| Periodo | Termine usato | Concetto sottostante |
|---|---|---|
| Fine anni '70 | **Invalido** | Riabilitazione, reinserimento lavorativo |
...
La lezione usa un esercizio pratico per illustrare i diversi modi di leggere la stessa situazione:

> **Caso:** Una persona su sedia a rotelle si trova ai piedi di una scala e non può accedere al seggio elettorale. Perché?

Le risposte possibili rivelano il modello mentale di chi risponde:

### Modello individuale (centrato sulla persona)

- **Modello biomedico:** perché ha un danno alla spina dorsale
- **Modello funzionale/riabilitativo:** perché non può camminare

In entrambi i casi, il *problema* è nella persona. La soluzione? "Riparare" o compensare la persona.

### Modello sociale (centrato sul contesto)

- **Modello ambientale:** a causa della scala, una barriera architettonica
- **Modello civico dei diritti umani:** per un'esclusione sociale, una situazione di discriminazione
...
Pensa all'albero: la menomazione è un ramo storto, ma è l'ambiente (il vento, il muro, gli altri rami) a determinare se quel ramo diventa un ostacolo o no. La pianta non è "difettosa" — è l'ecosistema attorno che crea o rimuove il problema.
...
La logica è lineare e medica:

**EZIOLOGIA → PATOLOGIA → MANIFESTAZIONE CLINICA**

Si guarda alla *causa* della malattia. Non considera le conseguenze nella vita della persona. Utile per diagnosi clinica, limitato per capire l'impatto sociale.

Questo strumento nasce in un'epoca — dopo la Seconda Guerra Mondiale, fino agli anni '70 — dove il modello dominante era quello della **riabilitazione**: la persona con disabilità è qualcuno da "recuperare" e reintegrare nel lavoro tramite protesi che colmino una mancanza. C'è una *norma* da riacquistare.

Dagli anni '70 questo modello inizia a scricchiolare: il progresso medico porta malattie croniche che non permettono pieno recupero, e l'invecchiamento della popolazione aumenta la fragilità diffusa.

---

### ICIDH — Classificazione Internazionale delle Menomazioni, Disabilità e Handicap (1980)

Un passo avanti importante. L'ICIDH non si ferma alla causa della malattia, ma guarda alle sue *conseguenze*. Introduce tre concetti chiave:
...
5. L'handicap non è visto come concetto dinamico — può essere anche solo temporaneo

Soresi (2016) sottolinea un punto provocatorio: una persona non può essere "globalmente disabile", perché la disabilità emerge solo in certi contesti, quando si pretendono certi livelli di prestazione. Una menomazione agli arti inferiori non è disabilitante durante una partita di scacchi seduti. Una disabilità visiva non si manifesta mentre si ascolta Mozart. *Al variare del dove, del quando e del con chi*, variano le condizioni sperimentate dalla persona.
...
## L'inclusione: ideale, utopia e i suoi rischi

L'inclusione è oggi la parola di moda — e questo crea problemi.
...
Una sociolinguista citata a lezione fa notare che la stessa parola "inclusione" porta un problema: implica che qualcuno *include* qualcun altro. C'è ancora una relazione asimmetrica. L'ideale successivo sarebbe la **vera convivenza nella differenza** — ma le parole per descriverla ancora non abbiamo.

Gardou propone di usare soprattutto l'**aggettivo inclusivo** (scuola inclusiva, educazione inclusiva) perché porta il valore dell'inclusione sul piano delle pratiche concrete — qualcosa su cui possiamo agire ogni giorno.

---

## La lingua facile: integrativa o inclusiva?

La **lingua facile** è una modalità di scrittura semplificata (parole comuni, frasi brevi, layout chiaro) per rendere i testi accessibili a persone con difficoltà cognitive o di lettura.

La domanda posta a lezione: è uno strumento integrativo o inclusivo?
...
- **Lezioni 01-04:** movimenti associativi e Convenzione ONU (CDPD, 2006) — base valoriale da cui derivano i cambiamenti concettuali discussi qui
- **Libro di Gardou** (*Nessuna vita è minuscola*, 2016): approfondisce inclusione, diritti e visione di una società senza esclusi
- **Mainardi (2010):** schema dei quattro modelli istituzionali (esclusione, segregazione, integrazione, inclusione)
- **Soresi (2016):** analisi critica delle classificazioni OMS e della loro evoluzione
- **Da approfondire:** Universal Design for Learning (UDL) — progettare ambienti di apprendimento accessibili a tutti fin dall'inizio
