...
- **Percorso nei concetti** → evoluzione storica, terminologia, classificazioni
- **Percorso nei modelli interpretativi** → modelli di lettura dell'handicap
- **Percorso nelle situazioni di vita** → handicap di situazione, valutazione, intervento
- **Percorso nei quadri etici e legislativi** → diritti, norme, servizi
...
| Prova | Data | Contenuti | Peso |
|-------|------|-----------|------|
| Esame intermedio | 24.03.2026, 8.45–10.15 | 17 feb – 17 mar | 40% |
| Esame finale | Giugno 2026 | 1 apr – 27 mag (+ connessioni 1ª parte) | 60% |
...
`disabilità` · `handicap` · `deficit` · `inclusione` · `integrazione` · `società inclusiva` · `singolari plurali` · `patrimonio comune` · `agire comunicativo` · `normalità` · `vulnerabilità` · `ICD` · `ICIDH` · `ICF` · `LISPI` · `Convenzione ONU`
