...
### L'eredità in Svizzera e in Ticino
...
2. **Diritti economici, sociali e culturali**: diritto al lavoro, all'istruzione, alla sicurezza sociale.
3. **Diritti di "terza generazione"**: diritto allo sviluppo, a un ambiente sano.

---

## La CDPD: origine, struttura e logica
...
La CDPD è composta da 50 articoli, organizzati così:

| Sezione | Contenuto |
|---------|-----------|
| Preambolo | Non vincolante, principi fondamentali e definizione di disabilità |
| Art. 1–9 | Parte generale: scopo, definizioni, principi generali, obblighi |
| Art. 10–30 | Diritti specifici (vita indipendente, istruzione, lavoro, voto...) |
| Art. 31–40 | Messa in pratica e sorveglianza |
| Art. 41–50 | Disposizioni finali, regole tecniche |
| Protocollo Facoltativo | Procedura individuale di comunicazione e inchiesta (la Svizzera non ha aderito) |

### Perché una convenzione specifica?

La domanda è legittima: se esiste già la Dichiarazione Universale dei Diritti dell'Uomo, perché serve una convenzione dedicata alle persone con disabilità?
...
## Il Preambolo: i principi fondamentali

Il preambolo della CDPD richiama esplicitamente la Dichiarazione Universale dei Diritti dell'Uomo: ogni individuo è titolare di tutti i diritti senza distinzione, tutti i membri della famiglia umana hanno pari dignità.

Il punto cruciale del preambolo è la **definizione di disabilità**:
...
Fin qui ci siamo? Bene, adesso entriamo nel vivo degli articoli. Non li leggiamo tutti (sono 50!), ma quelli che contano davvero nel lavoro sociale.

### Art. 1 — Scopo

> *(…) proteggere e assicurare il pieno ed eguale godimento di tutti i diritti umani e di tutte le libertà fondamentali a tutte le persone con disabilità, e promuovere il rispetto per la loro intrinseca dignità.*

Definisce anche chi sono le persone con disabilità: persone con menomazioni fisiche, mentali, intellettuali o sensoriali a lungo termine, che in interazione con varie barriere possono impedire la loro piena partecipazione.

### Art. 4 — Obblighi generali

Gli stati devono adottare misure legislative e amministrative per attuare i diritti riconosciuti, e modificare o abrogare qualsiasi legge o pratica che costituisca discriminazione. La Svizzera, non avendo firmato il Protocollo Facoltativo, applica questo articolo con margini di flessibilità.

### Art. 8 — Accrescimento della consapevolezza

Sensibilizzare la società, combattere stereotipi e pregiudizi, promuovere la consapevolezza sulle capacità delle persone con disabilità, rafforzare il sistema educativo al concetto di inclusione, incoraggiare i media a una rappresentazione rispettosa.
...
Le persone con disabilità hanno diritto di ricevere informazioni **attraverso forme di comunicazione di loro scelta**: Braille, lingua dei segni, lingua facile, ecc. Il contesto e le istituzioni devono adattarsi, non la persona. Da qui nasce l'impulso alla Lingua Facile.

### Art. 24 — Educazione

Gli stati devono garantire che il sistema educativo preveda l'integrazione a **tutti i livelli**, con:
- Sostegni individualizzati
- Modalità di comunicazione appropriate ai diversi bisogni
- Formazione dei docenti, anche con disabilità
- Accesso all'istruzione superiore e alla formazione continua

L'istruzione deve avvenire principalmente in contesti inclusivi, non in ambienti separati.

### Art. 27 — Lavoro e occupazione

Diritto al lavoro in un mercato inclusivo, senza discriminazione. È l'articolo che le associazioni di categoria citano di più nell'Iniziativa per l'Inclusione, e quello su cui il controprogetto governativo è stato più criticato per la sua debolezza.
...
La raccolta sistematica di dati sulle persone con disabilità permette di pianificare politiche sociali basate su conoscenze concrete, invece di rispondere solo alle emergenze. Difficile fare confronti internazionali senza criteri comuni — la CDPD spinge verso una raccolta standardizzata.
...
> Dal punto di vista critico (Dossier atgabbes 2013, Prof. Adriano Previtali, Univ. Friburgo): la CDPD ha anche limiti formali (testo prolisso, poco conciso) e materiali (molte disposizioni non direttamente applicabili in Svizzera senza atto legislativo). L'effettività dipende dalla volontà politica e dalle risorse messe a disposizione.

---

## La CDPD in Svizzera: attivismo e iniziative concrete

### Manifestazioni nazionali

Nel 2022 e 2024 si sono tenute manifestazioni nazionali a Berna (piazza del Consiglio Federale) per chiedere una piena applicazione della CDPD. Centinaia di persone, in tutte e quattro le lingue — e con modalità di comunicazione alternative.
...
- Layout lineare, carattere chiaro e grande, no colonne multiple

### Chi beneficia

La Lingua Facile non è solo per le persone con disabilità intellettiva:

- Persone con difficoltà di apprendimento
- Grandi anziani
- Persone con "analfabetismo di ritorno" (chi non usa spesso la lingua scritta)
- Persone di lingua madre diversa dall'italiano
- Persone sorde (la loro lingua — la lingua dei segni — è strutturalmente più sintetica della lingua scritta)
...
**RSI:** da gennaio 2025, il notiziario radiofonico delle 11.45 su Rete Uno è in lingua facile. Disponibile anche sul sito e su un canale WhatsApp dedicato.
...
- **Sessioni 01–03**: storia dell'eugenetica, istituzionalizzazione, modelli di disabilità — il contesto storico da cui emerge la necessità della CDPD.
- **Lettura obbligatoria**: Charles Gardou, *La vita in minuscolo* — affronta la dignità e il diritto di appartenere alla "famiglia umana", concetto centrale nel preambolo della CDPD.

### Temi aperti / da approfondire
- **ICF** (Classificazione Internazionale del Funzionamento): collegamento diretto con il modello bio-psico-sociale promosso dalla CDPD — argomento delle prossime lezioni.
- **Codice di deontologia del lavoro sociale**: fa esplicito riferimento alla Dichiarazione Universale dei Diritti dell'Uomo e impegna il professionista ad attivarsi per il rispetto dei diritti delle persone accompagnate.
- **INSOS**: associazione nazionale dei fornitori di servizi per persone con disabilità, spesso citata rispetto all'Iniziativa per l'Inclusione.
- **Iniziativa per l'Inclusione**: iter parlamentare ancora in corso (2024–2026).
