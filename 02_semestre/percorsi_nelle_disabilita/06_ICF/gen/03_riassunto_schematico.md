...
1. Funzioni mentali (coscienza, orientamento, memoria, attenzione, intelletto...)
...
7. Funzioni neuro-muscoloscheletriche e movimento
8. Funzioni della cute e strutture correlate

### Strutture corporee (8 domini — stessa suddivisione)
- Parti anatomiche del corpo: organi, arti, componenti
...
| 8 | Aree di vita principali (istruzione, lavoro, economia) |
...
## La Codifica (sistema alfanumerico)

| Lettera | Componente | Parte |
|---------|-----------|-------|
| `b` | Funzioni corporee | 1 |
| `s` | Strutture corporee | 1 |
