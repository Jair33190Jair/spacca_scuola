...
- **Definizione AAIDD (2022)** → limitazioni significative in funzionamento intellettivo + comportamento adattivo, con esordio prima dei 22 anni · (Lez. 07)
- **3 criteri diagnostici** (tutti e tre devono coesistere):
  - **A. Funzionamento intellettivo** → QI < 70 (≥ 2 DS sotto la media; test Wechsler, Stanford-Binet)
...
**Modello funzionale (Wehmeyer, 1999):**
- **Capacità** (dimensione individuale) + **Opportunità** (dimensione ambientale) → con **sostegni** lungo tutta la vita → **comportamento autodeterminato**
...
|-----|-----------|---------|
| **Charles Gardou** | *Nessuna vita è minuscola* (2016); 5 assiomi; "Terza nazione del mondo" | 01, 05 |
...
| **Murphy, R.F.** | Concetto di liminalità (*Il silenzio del corpo*, Erickson 2017) | 11 |
| **Lepri, C.** | Adultità nelle persone con disabilità intellettiva; "eterno bambino"; 3 condizioni | 11 |
