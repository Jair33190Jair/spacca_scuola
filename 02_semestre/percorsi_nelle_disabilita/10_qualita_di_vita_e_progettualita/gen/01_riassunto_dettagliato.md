...
## Il Cambio di Sguardo: da Medico a Bio-Psico-Sociale

Prima di entrare nella qualità di vita, la professoressa ripassa il cambio epocale che hai già incontrato nelle lezioni precedenti. È importante tenerlo a mente perché tutto il resto si regge qui.

**Sguardo medico-individualista:**
- La persona *è* la sua diagnosi e il suo deficit
- Gli specialisti hanno il sapere, l'operatore "prescrive" ("devi fare così!")
- Il futuro è standardizzato e statico
- La priorità è la protezione dai rischi, postura paternalistica

**Sguardo bio-psico-sociale (ICF + Convenzione ONU):**
- La diversità è un modo originale di relazionarsi al mondo
- Tutti hanno potenziali di sviluppo
- Il focus si sposta dal deficit alla persona nel suo contesto
- L'operatore accompagna ("cosa vorresti fare?"), lavora sui contesti, costruisce reti di sostegno
- Si accetta il rischio dell'indipendenza

In pratica, si passa da:

| Vecchio paradigma | Nuovo paradigma |
|---|---|
| Eterno bambino | Adultità |
| Dipendenza | Autonomia |
| Malattia / diagnosi | Funzionamento / sostegni |
| Emarginazione | Inclusione |
| Bisogni | Diritti e desideri |
...
## Il Paradigma della Qualità di Vita (QdV)
...
La prof usa una metafora efficace: la qualità di vita è come un'orchestra sinfonica personale.

- La persona dovrebbe essere **il compositore** (scrive la partitura = definisce obiettivi e valori)
- **Il direttore d'orchestra** (interpreta e dà ritmo = gestisce la propria vita)
- **Il primo strumento** (partecipa attivamente = è protagonista)

La qualità complessiva del concerto dipende da:
- Come il musicista interpreta la musica → **percezione soggettiva**
- Il giudizio del pubblico → **valutazione oggettiva**
- Quanti strumenti sono disponibili → i **sostegni**
...
## Il Meta-Modello di Schalock e Verdugo

### Cos'è un "meta-modello"?

Si chiama meta-modello perché è una sintesi di numerosi studi e modelli provenienti da discipline diverse, costruita in oltre vent'anni di ricerca. È riconosciuto a livello internazionale e usato non solo per la disabilità, ma anche per anziani, persone con malattie croniche, e per valutare la qualità di vita dei lavoratori.
...
Le evidenze scientifiche mostrano che la QdV migliora quando:
1. Le persone partecipano alle decisioni che le riguardano (empowerment / autodeterminazione)
2. C'è accettazione e inclusione nella comunità
3. Vengono forniti sostegni di qualità
...
## Gli Indicatori: dal Concetto alla Pratica
...
- Individuare e risolvere ostacoli, barriere e discriminazioni
...
## La Valutazione Iniziale (Assessment)
...
La valutazione si può fare attraverso:
- **Osservazioni partecipanti**: stare con le persone, cogliere situazioni
- **Colloqui e interviste strutturate** basate sui domini della QdV
...
- Stabilito in modo condiviso in équipe, con l'utente e la rete
- Tiene in considerazione desideri, motivazioni, piaceri e passioni dell'utente
- Tiene in considerazione anche le risorse dell'ambiente
- Integrato con il piano settimanale delle attività
...
- **Lezioni precedenti**: ICF e approccio bio-psico-sociale sono la base teorica della QdV; sistema dei sostegni; Convenzione ONU
- **Prossima lezione**: approfondimento dell'**autodeterminazione** — uno dei domini più dibattuti

### Autori principali di questa lezione
